      ...
      <Tabs value={activeTab} onValueChange={setActiveTab} className="flex flex-col gap-6">
        ...
        <TabsContent value="home" className="flex flex-col gap-8 mt-0">
          <div className="flex flex-col gap-3">
            <SectionHeader title="Monthly Overview" description="This month at a glance" tabTarget="analytics" />
            {StatCards}
          </div>

          <div className="flex flex-col gap-3">
            <SectionHeader title="Spending Trend" description="Daily expenses over the last week" tabTarget="analytics" />
            {SpendingTrendChart}
          </div>

          <div className="flex flex-col gap-3">
            <SectionHeader title="Budget Progress" description="How you are tracking against your limits" tabTarget="budgets" />
            {BudgetOverviewCard}
          </div>

          <div className="flex flex-col gap-3">
            <SectionHeader title="Recent Transactions" description={`${allTransactions.length} total transactions`} tabTarget="transactions" />
