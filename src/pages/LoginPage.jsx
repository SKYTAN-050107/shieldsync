    ...
    return (
        <div className="min-h-screen flex items-center justify-center p-4 relative overflow-hidden"
            ...
            <div className="absolute inset-0 overflow-hidden pointer-events-none">
                <div className="absolute top-[18%] left-[18%] w-36 h-36 rounded-full opacity-30 animate-pulse"
                    style={{
                        background: 'radial-gradient(circle, rgba(59, 130, 246, 0.12) 0%, transparent 70%)',
                        backdropFilter: 'blur(24px)',
                        border: '1px solid rgba(59, 130, 246, 0.1)',
                    }} />
                <div className="absolute top-[70%] right-[20%] w-28 h-28 rounded-full opacity-25 animate-pulse"
                    style={{
                ...
                <div className="absolute top-[45%] right-[30%] w-20 h-20 rounded-full opacity-20 animate-pulse"
                    style={{
                ...
                <div className="px-7 pb-7 pt-4 space-y-5">
                    ...
                    <form onSubmit={handleLogin} className="space-y-4">
                        <div className="space-y-1.5">
                            <label htmlFor="email" className="text-[10px] font-bold text-white/50 uppercase tracking-[0.2em]">
                                Email
                            </label>
                           ...
                           focus:ring-1 focus:ring-primary-400/40 focus:border-primary-400/30 
                        ...
                        <div className="space-y-1.5">
                            <label htmlFor="password" className="text-[10px] font-bold text-white/50 uppercase tracking-[0.2em]">
                                Password
                            </label>
                            <div className="relative">
                        ...
                        <div className="flex justify-end">
                            <a href="#" className="text-xs text-primary-300/60 hover:text-primary-300 transition-colors">
                                Forgot password?
                            </a>
                        </div>
                    ...
                    <p className="text-center text-xs text-white/35">
                        ...
                        <Link to="/signup" className="text-primary-300/70 hover:text-primary-300 transition-colors font-semibold">
                            Create one
                        </Link>
                    </p>
                </div>
